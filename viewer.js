...
export class Viewer {
    constructor(div) {
        ...
        if(!DEBUG || true) {
            new THREE.CubeTextureLoader().loadAsync([1,3,4,5,0,2].map(e => `panorama/panorama_${e}.png`)).then(cubeTexture => {
        ...
        if(parent && parent != window) {
            ...
            this.load_url("A+Minecraft+Movie+Hero+Pack-fbb3801e-25fc-c013-88ef-ebf38d3b805a-spack0.mcpack");
            //this.load_url("Legendary Icons spack0.mcpack");
            //this.load_url("58b56dff-be3d-4803-9b73-861f57d4d32f (persona_piece).mcpersona");
            //this.load_url("gourdian_pumpkin.geometry.json");
        } else {
    ...
    addSkin(mesh) {
        mesh.addEventListener("click", (event) => {
            ...
            TWEEN.add(new TWEEN.Tween(coords)
            .to(center, 100)
            .onUpdate(() => {
